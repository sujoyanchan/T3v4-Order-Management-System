        ...
        <>
            <center>
                ...
                <form>
                    ...
                    <ul>
                        <li>
                            <input type='checkbox' checked={tea} onChange={hTea} id="teaCheckbox" className='largerCheckbox' />
                        ...
                        <li>
                            <input type='checkbox' checked={coffee} onChange={hCoffee} id="coffeeCheckbox" className='largerCheckbox' />
                            <label htmlFor="coffeeCheckbox">COFFEE</label>
                            <br />
                            <img src="https://icons.iconarchive.com/icons/kzzu/i-love-you/128/Coffee-brown-icon.png" alt='' />
                        </li>

                        <li>
                            <input type='checkbox' checked={juice} onChange={hJuice} id='juiceCheckbox' className='largerCheckbox' />
                            <label htmlFor="juiceCheckbox">JUICE</label>
                            <br />
                            <img src="https://icons.iconarchive.com/icons/sonya/swarm/128/Juice-icon.png" alt='' />
                        </li>

                        <li>
                            <input type='checkbox' checked={milkshake} onChange={hMilkshake} id='shakeCheckbox' className='largerCheckbox' />
                            <label htmlFor="shakeCheckbox">MILKSHAKE</label>
                            <br />
                            <img src="https://icons.iconarchive.com/icons/iconarchive/fat-sugar-food/128/Milkshake-Chocolate-icon.png" alt='' />
                        </li>

                        <li>
                            <input type='checkbox' checked={soda} onChange={hSoda} id='sodaCheckbox' className='largerCheckbox' />
                            <label htmlFor="sodaCheckbox">SODA</label>
                            <br />
